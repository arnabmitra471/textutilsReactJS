    ...
    return (
        <>
            <div className="container">
                ...
                <div className="mb-3">
                    <textarea className="form-control" id="myBox" rows="8" value={text} onChange={handleOnChange} style={{backgroundColor:props.mode==="light"?"rgb(255,255,255)":"rgb(31,40,106)"}}></textarea>
                </div>
